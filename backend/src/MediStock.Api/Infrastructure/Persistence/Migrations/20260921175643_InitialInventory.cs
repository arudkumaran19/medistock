        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryBalances_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryBalances_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufacturingDateUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    QuantityOnHand = table.Column<int>(type: "integer", nullable: false),
                    FacilityId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryBalances_FacilityId",
                table: "InventoryBalances",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryBalances_MedicineId_FacilityId",
                table: "InventoryBalances",
                columns: new[] { "MedicineId", "FacilityId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineBatches_MedicineId_FacilityId_BatchNumber",
                table: "MedicineBatches",
                columns: new[] { "MedicineId", "FacilityId", "BatchNumber" },
                unique: true);
