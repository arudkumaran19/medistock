...
namespace MediStock.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925074601_FixDeliveryPurchaseOrderRelationship")]
    partial class FixDeliveryPurchaseOrderRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediStock.Api.Features.Inventory.Models.InventoryBalance", b =>
                {
                    b.HasOne("MediStock.Api.Domain.Entities.Facility", "Facility")
                        .WithMany()
                        .HasForeignKey("FacilityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
